...
void printCSV(resultsVector rv)
{
    ...
    result r;
     ...
     printf(",As,Cs,Gs,Ns,Ts,coverage,expected_number_of_errors,majorbase_ratio,majorbases,majorsequence,position,probability_of_seq_error,secondbase,secondbase_ratio\n");
	...
	printf("%u, %u, %u, %u, %u, %u, %u, %f, %f, %u, %c, %u, %f, %u, %f\n", 
	       i, r.A, r.C, r.G, r.N, r.T, r.coverage, r.coverage * r.meanError, r.frequencyMajorBase, r.majorBaseCount, r.majorBase, i, r.meanError, r.secondBaseCount, r.frequencySecondBase );
	}
